...
public class SmartShopShirtCategory extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SmartShopShirtCategory frame = new SmartShopShirtCategory(null);
	 ...
	 * Create the frame.
	 */
	public SmartShopShirtCategory(String email2) {
		this.email = email2;
