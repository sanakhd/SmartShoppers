...
public class SmartShopView extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SmartShopView frame = new SmartShopView(null);
	 ...
	 * Create the frame.
	 */
	public SmartShopView(String email2) {
		this.email = email2;
		 ...
		 * ====================Welcome to VS Label========================
		 */
		JLabel lblNewLabel = new JLabel("Welcome to Smart Shop!");
		lblNewLabel.setBounds(40, 526, 373, 63);
		...
		ImageIcon virtualShopimgage = new ImageIcon(this.getClass().getResource("/smartshop.jpeg").getFile());
		...
		btnNewButton_5.setBackground(new Color(139, 0, 139));
		btnNewButton_5.setBounds(6, 645, 61, 20);
		panel_1.add(btnNewButton_5);
		virtualShop.setIcon(virtualShopimgage);
		virtualShop.setBounds(17, 8, 793, 595);
		...
		myProfile.setBounds(1061, 58, 117, 35);
		panel.add(myProfile);
		...
		category.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		        ...
		        switch(value){
		        case "Joggers":
		            SmartShopJoggersCategory b1 = new SmartShopJoggersCategory(email); // call the class
		            b1.setLocationRelativeTo(null);
		            b1.setVisible(true);    // set the jframe to visible 
		            break;
		        case "Crewneck":
		        	 SmartShopCrewneckCategory b2 = new  SmartShopCrewneckCategory(email); // call the class
		            b2.setLocationRelativeTo(null);
		            b2.setVisible(true);    // set the jframe to visible 
		            break;
		        case "Shirt":
		        	SmartShopShirtCategory b3 = new  SmartShopShirtCategory(email); // call the class
		...
		btnLogout.setBounds(1061, 619, 117, 35);
		panel.add(btnLogout);
