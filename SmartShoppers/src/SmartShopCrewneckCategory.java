...
public class SmartShopCrewneckCategory extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SmartShopCrewneckCategory frame = new SmartShopCrewneckCategory(null);
	 ...
	 * Create the frame.
	 */
	public SmartShopCrewneckCategory(String email2) {
		this.email = email2;
