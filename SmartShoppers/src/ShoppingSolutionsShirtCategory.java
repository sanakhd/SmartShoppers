...
public class ShoppingSolutionsShirtCategory extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ShoppingSolutionsShirtCategory frame = new ShoppingSolutionsShirtCategory(null);
	 ...
	 * Create the frame.
	 */
	public ShoppingSolutionsShirtCategory(String email2) {
		this.email = email2;
