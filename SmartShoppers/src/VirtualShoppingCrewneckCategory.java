...
public class VirtualShoppingCrewneckCategory extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VirtualShoppingCrewneckCategory frame = new VirtualShoppingCrewneckCategory(null);
	 ...
	 * Create the frame.
	 */
	public VirtualShoppingCrewneckCategory(String email2) {
		this.email = email2;
