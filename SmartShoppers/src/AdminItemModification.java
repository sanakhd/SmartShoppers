...
public class AdminItemModification extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AdminItemModification frame = new AdminItemModification();
	...
	public AdminItemModification() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(id.getText().equals("") || name.getText().equals("") || price.getText().equals("") || quantity.getText().equals("")
						|| category.getText().equals("") || store.getText().equals("")) {
		...
		btnNewButton.setBounds(34, 262, 86, 29);
		...
		btnRemove.setBounds(141, 259, 86, 29);
		panel.add(btnRemove);
		...
		lblStore.setBounds(33, 236, 86, 16);
		panel.add(lblStore);
		
		store = new JTextField();
		store.setColumns(10);
		store.setBounds(140, 231, 108, 26);
		panel.add(store);
