...
public class ShoppingSolutionsJoggersCategory extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ShoppingSolutionsJoggersCategory frame = new ShoppingSolutionsJoggersCategory(null);
	 ...
	 * Create the frame.
	 */
	public ShoppingSolutionsJoggersCategory(String email2) {
		this.email = email2;
