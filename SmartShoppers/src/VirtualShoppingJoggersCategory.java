...
public class VirtualShoppingJoggersCategory extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VirtualShoppingJoggersCategory frame = new VirtualShoppingJoggersCategory(null);
	 ...
	 * Create the frame.
	 */
	public VirtualShoppingJoggersCategory(String email2) {
		this.email = email2;
